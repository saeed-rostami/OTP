                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu account-menu">
                            <li><a href="{{route('User-Profile')}}"><i class="fa fa-edit color-1"></i>Edit
                                    profile</a></li>
                            <li><a href="{{route('Video-Request')}}"><i class="fa fa-video-camera color-2"></i>Request Video</a></li>
                            <li><a href="{{route('Admin-Index')}}"><i class="fa fa-video-camera color-2"></i>Admin Panel</a></li>
                            <li><a href="{{route('Favorites')}}"><i class="fa fa-star color-3"></i>Favorites</a></li>
