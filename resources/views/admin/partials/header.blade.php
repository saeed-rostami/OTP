            ...
            <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="{{asset('storage/' . auth()->user()->avatar)}}" class="img-thumbnail
                                 img-fluid" style="width: 30px; height: 30px;">
                            </span>
                    <strong class="username">{{auth()->user()->name . auth()->user()->family}}</strong>
                    <b class="caret"></b>
                </a>
