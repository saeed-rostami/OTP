                ...
                <div class="col-md-8 portlets">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="pull-left">Edit the Video</div>
                        ...
                        <div class="panel-body">
                            <div class="padd">
                                ...
                                <div class="form quick-post">
                                    ...
                                    <form class="form-horizontal" action="{{route('Admin-Video-Update' , $video->id)}}"
                                    ...
                                    <!-- Title -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <label for="select2-categories"></label><select id="select2-categories"
